#!/usr/bin/env python3
# -*-coding:utf8-*-
# ROHAN NOTE: this file is used by data collection
import rclpy
...
from piper.util.station_util import get_station_number
...
class PiperRosNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.end_pose_pub = self.create_publisher(Pose, 'follower_eef_pose', 1)
        ...
        self.create_subscription(JointState, 'master_joint_states', self.joint_callback, 1)
